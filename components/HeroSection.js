                    ...
                    <SwiperSlide key={post.id}>
                        ...
                        >
                            ...
                            <div className="mx-auto w-[75vw] h-full">
                                <div className="relative z-10 flex flex-col items-start justify-end w-full h-full text-orange-50 pb-8 px-0 sm:px-8 lg:px-0">
                                    <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-5xl 2xl:text-6xl font-md mb-4 mt-20 sm:mt-2">{post.title}</h1>
                                    <p className="hidden lg:block text-sm sm:text-md lg:text-lg mb-3 md:mb-6 max-w-xl text-[#e9e8e6]">
                                        {post.preview}
                                    </p>
                                    <a
